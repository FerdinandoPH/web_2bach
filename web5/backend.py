...
2: Dependencias que hay que instalar (las no mencionadas ya vienen con python):
    ...
    d: serpapi (pip install google-search-results)
        ...
        Es necesario crear una cuenta en https://serpapi.com/ para obtener la llave de la API. Una vez creada, ponla en el hueco marcado en el código (línea 89). Se pueden hacer 100 peticiones al mes de forma gratuita.
