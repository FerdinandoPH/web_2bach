...
async def mandaMensage(websocket, path):
    ...
    try:
        ...
        prompt="Un campesino egipcio con la corona de faraón en unos campos en"+listapalabras[1]+", con "+listapalabras[2]+" a su lado, con un estilo fotorrealista",
        n=1,
        size="512x512"
        )
